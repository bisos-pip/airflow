...
(webserver, scheduler, triggerer, database, and DAG development/testing)
as a set of BISOS Capability Bundles (CBS/CBM) and =systemd=-planted
Command Services. It is under active initial development; this README
is a starting point and will be expanded as the package matures.

*The remainder of this document is carried over from* =bisos.dockerProc=
*(the starting-point template this package was copied from) and still
describes docker/podman container lifecycle management. It will be
rewritten to describe bisos.airflow as the package develops.*
...
- [[#use-cases][Use Cases]]
  - [[#rawbisos-reconstruction-----bisoss-equivalent-of-the-common-cicd-pipeline][RawBisos-Reconstruction --- BISOS's Equivalent of the Common CI/CD Pipeline]]
...
An overview of the relevant files of the bisos.dockerProc package (starting-point
template; to be updated to reflect bisos.airflow's actual files):
...
See [[file:./panels/bisos.airflow/_nodeBase_/fullUsagePanel-en.org]]
